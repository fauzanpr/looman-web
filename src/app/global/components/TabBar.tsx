...
function TabBar() {
    ...
    return (
        <>
            {isAdd ? <button className={`bg-primary w-4/5 text-white text-base py-3 px-10 rounded-xl absolute bottom-24 left-1/2 -translate-x-1/2`}>Mulai Donasi</button> : null}
